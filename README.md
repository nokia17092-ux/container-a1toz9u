...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-a1toz9u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-a1toz9u.containers.anotherwebservice.com/
...
```
git clone git@github.com:nokia17092-ux/container-a1toz9u.git
cd container-a1toz9u
```
...
```
docker attach container-a1toz9u
```
